      ...
      <div className="container px-4 md:px-8 mx-auto w-auto">
        ...
        >
          <animated.div className="relative z-10" style={pfpSpring}>
            <img
              id="pfp"
              className="relative rounded-full border-solid border-pastelBlue-500 border-4 w-auto h-32 md:h-48"
              src={TheriotPFP}
            />
          </animated.div>
          <animated.h1
          ...
          <div className="my-4">
          <Link to="/656-2">
              <button className="bg-pastelBlue-500 hover:bg-pastelBlue-700 text-white font-bold py-2 px-4 rounded mb-4 md:my-4 lg:my-2" style={{ height: 50, width: 230 }}>
                ASSIGNMENT 2
              </button>
            </Link>
          </div>
          <animated.p style={descriptionSpring}>
            ...
            I joined <strong>Computers and New Media</strong> to better
            understand the way humans interact with technology. I'm extremely
            interested in the art of story telling and can't wait to dive deeper
            into the ways that has changed, and will continue to change, with
